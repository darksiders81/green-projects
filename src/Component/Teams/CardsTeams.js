...
export default function CardsTeams(props) {
    ...
    return (
        <Col xxl={3} xl={3} lg={4} md={6} sm={12} xs={12} >
            <Card className='border-0 bg-light mx-auto my-2 g-2 w-100' >
                <Card.Img className='m-0' variant="top" src={props.image} />
                <Card.Body>
                    <Card.Title className='text-center fw-bolder'>{props.name}</Card.Title>
                    <Card.Text className='text-center fw-medium text-black-50'>
                        {props.job}
